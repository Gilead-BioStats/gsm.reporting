...
dfSiteCounts <- gsm.core::RunQuery(df = mapped$Mapped_ENROLL,
...
dfStudyCounts <- gsm.core::RunQuery(df = mapped$Mapped_ENROLL,
...
dfCountryCounts <- gsm.core::RunQuery(df = mapped$Mapped_ENROLL,
